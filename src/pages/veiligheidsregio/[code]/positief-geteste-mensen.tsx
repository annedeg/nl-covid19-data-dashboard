...
const PostivelyTestedPeople: FCWithLayout<ISafetyRegionData> = (props) => {
  ...
  const regionMunicipals = regionCodeToMunicipalCodeLookup[data.code];
  const selectedMunicipal = regionMunicipals ? regionMunicipals[0] : undefined;
